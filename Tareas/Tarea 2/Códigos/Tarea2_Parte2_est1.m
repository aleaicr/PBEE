...
IM_1_interp1 = 0.1:0.1:max(IM_1);
IM_2_interp1 = 0.1:0.1:max(IM_2);
...
hold on
loglog(IM_2sec_interp1,lambda_IM_interp1,'.-','Color','b')
loglog(IM_1_5_sec,lambda_IM_interp1,'.-')
loglog(IM_1_interp1,lambda_1_interp1,'.-','Color','r')
loglog(IM_2_interp1,lambda_2_interp1,'.-','Color','b')
hold off
xlabel('IM = Sa(T1) [g]')
...
title('Curvas de amenaza interpoladas')
legend('T=1[sec]','T=2[sec]','T = 1.5[sec]','Curva 1sec interp en IM', 'Curva 2 sec interp IM')
grid on
